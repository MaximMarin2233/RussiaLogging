                ...
                <div className={styles['alerts__card-social']}>
                  <div className={styles['alerts__card-social-block']}>
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect width="22" height="22" rx="8" fill="#2AD200" fill-opacity="0.1" />
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M17.4707 8.6038C17.1955 8.27231 16.7038 8.22661 16.3723 8.50172L8.77881 14.541L9.77508 15.7415L10.9755 14.7452L17.3686 9.70215C17.7001 9.42703 17.7458 8.93528 17.4707 8.6038Z" fill="#81FF46" />
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M10.9755 14.7452L9.77508 15.7415L8.77881 14.541L6.49819 11.793C6.22307 11.4616 6.26877 10.9698 6.60026 10.6947C6.93175 10.4196 7.4235 10.4653 7.69861 10.7968L10.9755 14.7452Z" fill="#81FF46" />
                    </svg>
                    Уведомления
                  </div>
                  <div className={styles['alerts__card-social-block']}>
