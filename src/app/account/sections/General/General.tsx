        ...
        <div className={styles['general__accounts']}>
          ...
          <ul className={`list-reset ${styles['general__accounts-list']}`}>
                ...
                <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <defs>
                    <linearGradient id="paint0_linear_456_4354" x1="0" y1="0" x2="55.3025" y2="64.2389" gradientUnits="userSpaceOnUse">
                      ...
                      <stop offset="1" stop-color="#1A91CB" />
                    </linearGradient>
              ...
              <div className={styles['general__accounts-item-btns']}>
                <button className={`btn-reset ${styles['general__accounts-item-btn']}`}>
                  <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="50" height="50" rx="12.5" fill="white" fill-opacity="0.1" />
            ...
            <li className={`${styles['general__accounts-item']} ${styles['general__accounts-item--vk']}`}>
              <div className={styles['general__accounts-item-logo']}>
                <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M9.16667 0C4.10405 0 0 4.10406 0 9.16667V34.8333C0 39.8959 4.10406 44 9.16667 44H34.8333C39.8959 44 44 39.8959 44 34.8333V9.16667C44 4.10405 39.8959 0 34.8333 0H9.16667Z" fill="url(#paint0_linear_456_4358)" />
                  ...
                  <defs>
                    <linearGradient id="paint0_linear_456_4358" x1="0" y1="0" x2="55.3025" y2="64.2389" gradientUnits="userSpaceOnUse">
                      ...
                      <stop offset="1" stop-color="#0092EC" />
                    </linearGradient>
                  </defs>
                </svg>
            ...
            <li className={`${styles['general__accounts-item']} ${styles['general__accounts-item--google']}`}>
              <div className={styles['general__accounts-item-logo']}>
                <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M9.16667 0C4.10405 0 0 4.10406 0 9.16667V34.8333C0 39.8959 4.10406 44 9.16667 44H34.8333C39.8959 44 44 39.8959 44 34.8333V9.16667C44 4.10405 39.8959 0 34.8333 0H9.16667Z" fill="url(#paint0_linear_456_4362)" />
