    ...
    <section className={styles['general']}>
      <div className="container">
        ...
        <div className={styles['general__characters']}>
          ...
          {filledSlots.slice(0, 3).map((char, index) => {

            if (!char) {
              return (
                <div key={index} className={`${styles['general__character']} ${styles['general__character--empty']}`}>
                  <div className={styles['general__character-empty-title']}>
                    Данный слот <br /> свободен
                  </div>
                  <div className={styles['general__character-empty-descr']}>
                    информации о персонаже нет
                  </div>
                </div>
              )
            }
            ...
            return (
              <div key={char.char_id} className={styles['general__character']}>
                ...
                <div className={styles['general__character-inf']}>
                  ...
                  {char.char_is_online === 1 ? (
                    <div className={styles['general__character-online-status']}>
